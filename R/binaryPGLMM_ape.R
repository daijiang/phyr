...
#' prone to inflated type 1 errors.} \item{mu}{for each data point y, the
#' estimate of p that y = 1.} \item{b}{for each data point y, the estimate of
#' inverse.logit(p).} \item{X}{the predictor (independent) variables returned

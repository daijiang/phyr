...
The main function to use is `phyr::communityPGLMM.plot.random.terms()`. Here are the arguments of this function:

```{r args-pglmm}
args(phyr::communityPGLMM.plot.random.effects)
```
...
mod1re = communityPGLMM.plot.random.effects(Y ~ 1 + env + (1|sp__) + (1|site) + (env|sp__) + (1|sp__@site),
...
communityPGLMM.plot.random.effects(Y ~ 1 + env + (1|sp__) + (1|site) + (env|sp__) + (1|sp__@site),
...
mod1sim = communityPGLMM.plot.random.effects(Y ~ 1 + env + (1|sp__) + (1|site) + (env|sp__) + (1|sp__@site),

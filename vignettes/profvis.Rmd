...
profvis({
  phyr::communityPGLMM(freq ~ 1 + shade + (1|sp__) + (1|site) + (1|sp@site), dat, 
                       cov_ranef = list(sp = phylotree), REML = T, cpp = F, optimizer = "bobyqa")
})
```
...
profvis({
  phyr::communityPGLMM(freq ~ 1 + shade + (1|sp__) + (1|site) + (1|sp@site), dat, 
                       cov_ranef = list(sp = phylotree), REML = T, cpp = T, optimizer = "bobyqa")
})
```
...
profvis({
  phyr::communityPGLMM(freq ~ 1 + shade + (1|sp__) + (1|site) + (1|sp@site), dat, 
                       cov_ranef = list(sp = phylotree), REML = T, cpp = F, optimizer = "Nelder-Mead")
})
```
...
profvis({
  phyr::communityPGLMM(freq ~ 1 + shade + (1|sp__) + (1|site) + (1|sp@site), dat, 
                       cov_ranef = list(sp = phylotree), REML = T, cpp = T, optimizer = "Nelder-Mead")
})
```
...
profvis({
  phyr::communityPGLMM(pa ~ 1 + shade + (1|sp__) + (1|site) + (1|sp@site), dat, 
                       family = "binomial", cov_ranef = list(sp = phylotree), REML = T, cpp = F, 
                       optimizer = "bobyqa")
})
```
...
profvis({
  phyr::communityPGLMM(pa ~ 1 + shade + (1|sp__) + (1|site) + (1|sp@site), dat, 
                       family = "binomial", cov_ranef = list(sp = phylotree), REML = T, cpp = T, 
                       optimizer = "bobyqa")
})
```
